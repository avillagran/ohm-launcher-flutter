...
class _OhmHomeScreenState extends State<OhmHomeScreen> {
  ...
  Future<void> _showDesktopSettings(int desktopIndex) async {
    await showModalBottomSheet<void>(
      ...
      builder: (_) => _DesktopSettingsSheet(
        ...
        ttfxEnabled: _desktopMap(desktopIndex)?['ttfxBackground'] as bool? ?? true,
        ttfxEffect: _desktopMap(desktopIndex)?['ttfxEffect'] as String? ?? 'matrix',
        ttfxText: _desktopMap(desktopIndex)?['ttfxText'] as String? ?? 'OHM',
        ttfxTextSize: (_desktopMap(desktopIndex)?['ttfxTextSize'] as num?)?.toInt() ?? 3,
        ttfxTextX: (_desktopMap(desktopIndex)?['ttfxTextX'] as num?)?.toDouble() ?? .5,
        ttfxTextY: (_desktopMap(desktopIndex)?['ttfxTextY'] as num?)?.toDouble() ?? .5,
        ttfxAudio: _desktopMap(desktopIndex)?['ttfxAudio'] as bool? ?? true,
        ttfxIntensity: (_desktopMap(desktopIndex)?['ttfxIntensity'] as num?)?.toInt() ?? 5,
        ttfxSpeed: (_desktopMap(desktopIndex)?['ttfxSpeed'] as num?)?.toDouble() ?? 1,
        ttfxResolution: (_desktopMap(desktopIndex)?['ttfxResolution'] as num?)?.toInt() ?? 2,
        ttfxReactivity: (_desktopMap(desktopIndex)?['ttfxReactivity'] as num?)?.toInt() ?? 2,
        ...
        onTtfxEnabled: (v) => unawaited(_setDesktopValue(desktopIndex, 'ttfxBackground', v)),
        onTtfxEffect: (v) => unawaited(_setDesktopValue(desktopIndex, 'ttfxEffect', v)),
        onTtfxText: (v) => unawaited(_setDesktopValue(desktopIndex, 'ttfxText', v)),
        onTtfxTextSize: (v) => unawaited(_setDesktopValue(desktopIndex, 'ttfxTextSize', v)),
        onTtfxTextX: (v) => unawaited(_setDesktopValue(desktopIndex, 'ttfxTextX', v)),
        onTtfxTextY: (v) => unawaited(_setDesktopValue(desktopIndex, 'ttfxTextY', v)),
        onTtfxAudio: (v) => unawaited(_setDesktopValue(desktopIndex, 'ttfxAudio', v)),
        onTtfxIntensity: (v) => unawaited(_setDesktopValue(desktopIndex, 'ttfxIntensity', v)),
        onTtfxSpeed: (v) => unawaited(_setDesktopValue(desktopIndex, 'ttfxSpeed', v)),
        onTtfxResolution: (v) => unawaited(_setDesktopValue(desktopIndex, 'ttfxResolution', v)),
        onTtfxReactivity: (v) => unawaited(_setDesktopValue(desktopIndex, 'ttfxReactivity', v)),
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    final activeDesktop = _desktopMap(_desktopIndex);
    final ttfxEnabled = activeDesktop?['ttfxBackground'] as bool? ?? true;
    final ttfxEffect = activeDesktop?['ttfxEffect'] as String? ?? 'matrix';
    final ttfxX = (activeDesktop?['ttfxTextX'] as num?)?.toDouble() ?? .5;
    final ttfxY = (activeDesktop?['ttfxTextY'] as num?)?.toDouble() ?? .5;
      ...
      child: AnnotatedRegion<SystemUiOverlayStyle>(
          ...
          child: Scaffold(
            ...
            children: [
              ...
              _buildRuntimeLayer(),
              if (!_busy && _bootError == null && ttfxEnabled)
                Positioned(
                  left: 10,
                  ...
                  child: TtfxMiniControls(
                    ...
                    y: ttfxY,
                    onPreviousEffect: () {
                      final index = TtfxBackground.effects.indexOf(ttfxEffect);
                      final previous = (index <= 0 ? TtfxBackground.effects.length : index) - 1;
                      unawaited(_setDesktopValue(
                          _desktopIndex, 'ttfxEffect', TtfxBackground.effects[previous]));
                    },
                    onNextEffect: () {
                      final index = TtfxBackground.effects.indexOf(ttfxEffect);
                      final next = (index + 1) % TtfxBackground.effects.length;
                      unawaited(_setDesktopValue(
                          _desktopIndex, 'ttfxEffect', TtfxBackground.effects[next]));
                    },
                    onXChanged: (value) => unawaited(
                        _setDesktopValue(_desktopIndex, 'ttfxTextX', value)),
                    onYChanged: (value) => unawaited(
                        _setDesktopValue(_desktopIndex, 'ttfxTextY', value)),
                  ),
                ),
